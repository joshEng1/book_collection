...
# Use Active Model has_secure_password [Rails guides
# gem "bcrypt", "~> 3.1.7"
...
# Use the database-backed adapters for Rails.cache, Active Job, and
# Action Cable
gem "solid_cache"
gem "solid_queue"
gem "solid_cable"
...
# Add HTTP asset caching/compression and X-Sendfile acceleration to
# Puma [https://github.com/basecamp/thruster/]
gem "thruster", require: false

# Use Active Storage variants [Rails guides
