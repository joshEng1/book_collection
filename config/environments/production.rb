...
Rails.application.configure do
  ...
  # Cache assets for far-future expiry since they are all digest
  # stamped.
  ...
  # Assume all access to the app is happening through a
  ...
  # Specify outgoing SMTP server. Remember to add smtp/* credentials
  # via rails credentials:edit.
  ...
  # ]
  #
  # Skip DNS rebinding protection for the default health check
  # endpoint.
